...
#==============================================
  ...
  set_property -dict [ list CONFIG.ID_WIDTH {0} \
				...
				CONFIG.HAS_PROT {0} \
				CONFIG.HAS_REGION {0} \
				CONFIG.HAS_QOS {0} ] $mips_cpu_axi_mem

  set_property CONFIG.ASSOCIATED_BUSIF {mips_cpu_axi_mem} [get_bd_ports system_clk]
...
#==============================================
  ...
  connect_bd_intf_net -intf_net cpu_mem [get_bd_intf_pins cpu_ddr_ic/S00_AXI] \
			[get_bd_intf_ports mips_cpu_axi_mem]
...
#=============================================
  ...
  if {${::act} == "pst_sim"} {
	  create_bd_addr_seg -range 0x10000 -offset 0x40000000 [get_bd_addr_spaces mips_cpu_axi_mem] [get_bd_addr_segs axi_bram_if/S_AXI/Mem0] cpu_mem
  } else {
	  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces mips_cpu_axi_mem] [get_bd_addr_segs axi_bram_if/S_AXI/Mem0] cpu_mem
  }
  create_bd_addr_seg -range 0x1000 -offset 0x80010000 [get_bd_addr_spaces mips_cpu_axi_mem] [get_bd_addr_segs axi_uart/S_AXI/Reg] CPU_UART
